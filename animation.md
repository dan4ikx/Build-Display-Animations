# Build Display Animations (BDA) 1.0 — структура формата

Этот документ описывает `.bda` версии **1.0**.

## 1. Что хранит BDA

BDA 1.0 хранит только анимацию Minecraft-персонажей:
...
BDA 1.0 не описывает модели, скины, предметы, звуки, частицы, события, команды, камеры, IK, constraints, physics или игровую логику.
...
Другие кости BDA 1.0 не поддерживает.
