...
**BDA (`.bda`) — Build Display Animations** — простой JSON-формат для хранения анимации Minecraft-персонажей.

BDA 1.0 специально ограничен только анимацией:
...
BDA 1.0 **не содержит** моделей, скинов, предметов, звуков, частиц, команд, камер, IK, событий или игровой логики.
